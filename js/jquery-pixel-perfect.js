(function($) {
  $.fn.pixelPerfect = function(options) {
    ...
    var JPP = (function() {
      ...
      JPP.prototype.initMockup = function() {
        var self = this;
        $self.prepend('<img id="j-pp-mockup" style="opacity: 0" src="' + self.options.path + '"/><div class="j-pp-mockup " style=""></div>');
        $(window).load(function() {
          ...
          $self.container.css({
            ...
            'background-image': 'url(' + self.options.path + ')'
          });
          $mockup.remove();
        });
      };

      JPP.prototype.initInterface = function() {
        $self.prepend(
          '<div class="j-pp-help">\
      ...
      JPP.prototype.draggingActions = function() {
      ...
      JPP.prototype.keyboardActions = function() {
        var self = this;
        ...
        $(document).on('keydown', function(event) {
          ...
          for (var key in self.options) {
            if (keyCode === self.options[key]) actions[key]();
          };
